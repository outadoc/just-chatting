...
class ClipUrlsDeserializer : JsonDeserializer<ClipUrlsResponse> {
    ...
    override fun deserialize(
        ...
        val videosJson =
            json.asJsonArray.first().asJsonObject.getAsJsonObject("data").getAsJsonObject("clip")
                .getAsJsonArray("videoQualities")
        videosJson.forEach {
            ...
            videos.add(
                ClipUrlsResponse.Video(
                    ...
                    video.getAsJsonPrimitive("sourceURL").asString.replace(
                        Regex("https://[^/]+"),
