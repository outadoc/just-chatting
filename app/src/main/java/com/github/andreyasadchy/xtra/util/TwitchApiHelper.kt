...
fun String.addTokenPrefixHelix() = "Bearer $this"
fun Int.formatViewersCount(context: Context): String {
    return context.resources.getQuantityString(R.plurals.viewers, this, "%,d".format(this))
}
...
fun String.getMessageIdString(context: Context): String? {
    return when (this) {
...
@DrawableRes
fun String.getMessageIdIcon(): Int? {
    return when (this) {
...
fun String.getNoticeString(context: Context, message: String?): String? {
    return when (this) {
