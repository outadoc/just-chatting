package fr.outadoc.justchatting.component.chat.data.parser
...
fun Map<String, String?>.parseBadges(): List<fr.outadoc.justchatting.component.chat.data.model.Badge>? =
    this["badges"]
        ?.splitAndMakeMap(",", "/")
        ?.entries
        ?.mapNotNull { (key, value) ->
            value?.let { fr.outadoc.justchatting.component.chat.data.model.Badge(key, value) }
        }
