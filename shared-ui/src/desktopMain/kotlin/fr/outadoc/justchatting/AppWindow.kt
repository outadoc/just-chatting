...
import fr.outadoc.justchatting.shared.internal.menu_file
...
@Composable
internal fun ApplicationScope.AppWindow(
    onCloseRequest: () -> Unit,
    onNewWindowRequest: () -> Unit,
) {
    Window(
        ...
        MenuBar {
            Menu(text = stringResource(Res.string.menu_file)) {
                Item(
