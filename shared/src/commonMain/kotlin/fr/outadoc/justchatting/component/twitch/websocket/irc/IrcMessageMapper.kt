                    ...
                    metadata = ChatEvent.Message.Highlighted.Metadata(
                        ...
                        subtitle = when (priorGifterDisplayName) {
                            null -> {
                                ...
                                Res.string.chat_subGift_payForward.format(priorGifterDisplayName)
                            }
                        },
                    ),
                    body = null,
            ...
            is IrcEvent.Message.ChatMessage -> {
                val metadata = when {
                    ...
                    paidMessageInfo != null -> {
                        ...
                        val header = Res.string.chat_paidMessage.format(formattedAmount)
                    ...
                    if (command.duration == null) {
                        ...
                        ChatEvent.Message.Highlighted(
                            ...
                            metadata = ChatEvent.Message.Highlighted.Metadata(
                                title = command.targetUserLogin.desc(),
                                titleIcon = Icon.Gavel,
                                subtitle = Res.string.chat_timeout.format(command.duration),
                            ),
                            body = null,
                        )
                    }
    ...
    private fun getLabelForNotice(messageId: String?, message: String?): StringDesc? {
        return when (messageId) {
            ...
            "already_followers_on" -> {
                Res.string.irc_notice_already_followers_on.format(
            ...
            "already_slow_on" -> {
                Res.string.irc_notice_already_slow_on.format(
                    message?.substringAfter("is already in ", "")
            ...
            "autohost_receive" -> {
                Res.string.irc_notice_autohost_receive.format(
            ...
            "bad_ban_admin" -> {
                Res.string.irc_notice_bad_ban_admin.format(
            ...
            "bad_ban_mod" -> {
                Res.string.irc_notice_bad_ban_mod.format(
            ...
            "bad_ban_staff" -> {
                Res.string.irc_notice_bad_ban_staff.format(
            ...
            "bad_delete_message_mod" -> {
                Res.string.irc_notice_bad_delete_message_mod.format(
            ...
            "bad_host_error" -> {
                Res.string.irc_notice_bad_host_error.format(
            ...
            "bad_host_hosting" -> {
                Res.string.irc_notice_bad_host_hosting.format(
            ...
            "bad_host_rate_exceeded" -> {
                Res.string.irc_notice_bad_host_rate_exceeded.format(
            ...
            "bad_mod_banned" -> {
                Res.string.irc_notice_bad_mod_banned.format(
                    message?.substringBefore(" is banned", "") ?: "",
                )
            }

            "bad_mod_mod" -> {
                Res.string.irc_notice_bad_mod_mod.format(
                    message?.substringBefore(" is already", "") ?: "",
                )
            }

            "bad_slow_duration" -> {
                Res.string.irc_notice_bad_slow_duration.format(
            ...
            "bad_timeout_admin" -> {
                Res.string.irc_notice_bad_timeout_admin.format(
            ...
            "bad_timeout_duration" -> {
                Res.string.irc_notice_bad_timeout_duration.format(
            ...
            "bad_timeout_mod" -> {
                Res.string.irc_notice_bad_timeout_mod.format(
            ...
            "bad_timeout_staff" -> {
                Res.string.irc_notice_bad_timeout_staff.format(
            ...
            "bad_unban_no_ban" -> {
                Res.string.irc_notice_bad_unban_no_ban.format(
            ...
            "bad_unmod_mod" -> {
                Res.string.irc_notice_bad_unmod_mod.format(
                    message?.substringBefore(" is not a", "") ?: "",
                )
            }

            "bad_vip_grantee_banned" -> {
                Res.string.irc_notice_bad_vip_grantee_banned.format(
                    message?.substringBefore(" is banned in", "") ?: "",
                )
            }

            "bad_vip_grantee_already_vip" -> {
                Res.string.irc_notice_bad_vip_grantee_already_vip.format(
            ...
            "bad_unvip_grantee_not_vip" -> {
                Res.string.irc_notice_bad_unvip_grantee_not_vip.format(
                    message?.substringBefore(" is not a", "") ?: "",
                )
            }

            "ban_success" -> {
                Res.string.irc_notice_ban_success.format(
                    message?.substringBefore(" is now banned", "") ?: "",
                )
            }

            "cmds_available" -> {
                Res.string.irc_notice_cmds_available.format(
            ...
            "commercial_success" -> {
                Res.string.irc_notice_commercial_success.format(
            ...
            "delete_message_success" -> {
                Res.string.irc_notice_delete_message_success.format(
            ...
            "delete_staff_message_success" -> {
                Res.string.irc_notice_delete_staff_message_success.format(
            ...
            "followers_on" -> {
                Res.string.irc_notice_followers_on.format(
            ...
            "host_on" -> {
                Res.string.irc_notice_host_on.format(
                    message?.substringAfter("Now hosting ", "")?.substringBeforeLast(".", "") ?: "",
                )
            }

            "host_receive" -> {
                Res.string.irc_notice_host_receive.format(
            ...
            "host_receive_no_count" -> {
                Res.string.irc_notice_host_receive_no_count.format(
                    message?.substringBefore(" is now hosting", "") ?: "",
                )
            }

            "host_target_went_offline" -> {
                Res.string.irc_notice_host_target_went_offline.format(
                    message?.substringBefore(" has gone offline", "") ?: "",
                )
            }

            "hosts_remaining" -> {
                Res.string.irc_notice_hosts_remaining.format(
                    message?.substringBefore(" host commands", "") ?: "",
                )
            }

            "invalid_user" -> {
                Res.string.irc_notice_invalid_user.format(
                    message?.substringAfter("Invalid username: ", "") ?: "",
                )
            }

            "mod_success" -> {
                Res.string.irc_notice_mod_success.format(
            ...
            "msg_banned" -> {
                Res.string.irc_notice_msg_banned.format(
            ...
            "msg_followersonly" -> {
                Res.string.irc_notice_msg_followersonly.format(
            ...
            "msg_followersonly_followed" -> {
                Res.string.irc_notice_msg_followersonly_followed.format(
                    message?.substringAfter("This room is in ", "")
                        ?.substringBefore(" followers-only mode", "") ?: "",
            ...
            "msg_followersonly_zero" -> {
                Res.string.irc_notice_msg_followersonly_zero.format(
            ...
            "msg_slowmode" -> {
                Res.string.irc_notice_msg_slowmode.format(
            ...
            "msg_subsonly" -> {
                Res.string.irc_notice_msg_subsonly.format(
            ...
            "msg_timedout" -> {
                Res.string.irc_notice_msg_timedout.format(
            ...
            "raid_error_unexpected" -> {
                Res.string.irc_notice_raid_error_unexpected.format(
            ...
            "room_mods" -> {
                Res.string.irc_notice_room_mods.format(
            ...
            "slow_on" -> {
                Res.string.irc_notice_slow_on.format(
            ...
            "timeout_no_timeout" -> {
                Res.string.irc_notice_timeout_no_timeout.format(
                    message?.substringBefore(" is not timed", "") ?: "",
                )
            }

            "timeout_success" -> {
                Res.string.irc_notice_timeout_success.format(
            ...
            "tos_ban" -> {
                Res.string.irc_notice_tos_ban.format(
            ...
            "turbo_only_color" -> {
                Res.string.irc_notice_turbo_only_color.format(
                    message?.substringAfter("following instead: ", "") ?: "",
                )
            }

            "unavailable_command" -> {
                Res.string.irc_notice_unavailable_command.format(
            ...
            "unban_success" -> {
                Res.string.irc_notice_unban_success.format(
                    message?.substringBefore(" is no longer", "") ?: "",
                )
            }

            "unmod_success" -> {
                Res.string.irc_notice_unmod_success.format(
            ...
            "unrecognized_cmd" -> {
                Res.string.irc_notice_unrecognized_cmd.format(
                    message?.substringAfter("Unrecognized command: ", "") ?: "",
                )
            }

            "untimeout_banned" -> {
                Res.string.irc_notice_untimeout_banned.format(
                    message?.substringBefore(" is permanently banned", "") ?: "",
                )
            }

            "untimeout_success" -> {
                Res.string.irc_notice_untimeout_success.format(
                    message?.substringBefore(" is no longer", "") ?: "",
                )
            }

            "unvip_success" -> {
                Res.string.irc_notice_unvip_success.format(
                    message?.substringAfter("You have removed ", "")
            ...
            "usage_color" -> {
                Res.string.irc_notice_usage_color.format(
            ...
            "usage_slow_on" -> {
                Res.string.irc_notice_usage_slow_on.format(
            ...
            "vip_success" -> {
                Res.string.irc_notice_vip_success.format(
                    message?.substringAfter("You have added ", "")
            ...
            "vips_success" -> {
                Res.string.irc_notice_vips_success.format(
