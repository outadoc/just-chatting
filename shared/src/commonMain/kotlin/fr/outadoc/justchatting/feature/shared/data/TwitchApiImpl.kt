...
internal class TwitchApiImpl(
    ...
    override suspend fun getStreamsByUserId(ids: List<String>): Result<List<Stream>> = twitchClient
    ...
    override suspend fun getCheerEmotes(userId: String?): Result<List<Emote>> = twitchClient
    ...
    override suspend fun getGlobalBadges(): Result<List<TwitchBadge>> = twitchClient
        .getGlobalBadges()
        .map { result ->
