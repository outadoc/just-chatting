...
internal inline fun logVerbose(tag: String, noinline content: () -> String) =
    Logger.println(Logger.Level.Verbose, tag, content)

internal inline fun logDebug(tag: String, noinline content: () -> String) =
    Logger.println(Logger.Level.Debug, tag, content)

internal inline fun logInfo(tag: String, noinline content: () -> String) =
    Logger.println(Logger.Level.Info, tag, content)

internal inline fun logWarning(tag: String, noinline content: () -> String) =
