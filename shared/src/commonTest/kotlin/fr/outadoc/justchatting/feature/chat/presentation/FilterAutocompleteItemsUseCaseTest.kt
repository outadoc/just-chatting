...
internal class FilterAutocompleteItemsUseCaseTest {
    private val filterAutocompleteItems = FilterAutocompleteItemsUseCase()
    ...
    fun `When parsing an empty string, recent emotes are returned`() {
        assertEquals(
            ...
            filterAutocompleteItems(filter = "", recentEmotes, mockEmotes, mockChatters),
        )
    }
    ...
    fun `When parsing a string matching both a chatter and an emote, both are returned`() {
        assertEquals(
            ...
            filterAutocompleteItems(filter = "ponce", recentEmotes, mockEmotes, mockChatters),
        )
    }
    ...
    fun `When parsing a string matching multiple items, they are all returned`() {
        assertEquals(
            ...
            filterAutocompleteItems(filter = "a", recentEmotes, mockEmotes, mockChatters),
        )
    }
}
